...
from services.file_service import json_file_generator, read_json_file
from fastapi import APIRouter, Depends, UploadFile, File
from fastapi.responses import JSONResponse

router = APIRouter()

@router.get("/view_json/{file_id}")
def view_json_file(file_id: int, conn = Depends(get_db)):
    try:
        ...
        json_file_content = read_json_file(abs_path=json_file_full_path)
        ...
        return JSONResponse(
            ...
            content={
                "status": "success",
                "status_code": 200,
                "message": "Converted contents are here!",
                "data": {
                    "file_id": int(file_id),
